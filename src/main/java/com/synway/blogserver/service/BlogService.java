...
import com.synway.blogserver.dao.mapper.BlogMapper;
...
public class BlogService {
   ...
   private BlogMapper blogMapper;
    ...
    public List<Blog> listBlogByCondition(Map<String,Object> params){
       return blogMapper.listBlogByCondition(params);
    }
}
